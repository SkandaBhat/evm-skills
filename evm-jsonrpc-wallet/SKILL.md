...
## Current status
- This package now defines JSON-RPC scope and coverage baseline.
- Runtime execution wrapper and full method adapters are planned in `docs/plans/json-rpc-only-skill-plan.md`.

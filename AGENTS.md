...
1. Keep the skill JSON-RPC-only.
2. Do not add alternate CLI fallbacks.
3. Remove obsolete docs/files when they no longer reflect the current architecture.

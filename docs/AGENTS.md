...
3. Prefer adding dated learning notes over rewriting history.
4. Keep the docs index (`docs/README.md`) current.
5. Add an entry in `docs/CHANGELOG.md` for every docs update.
